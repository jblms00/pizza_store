        ...
        <div class="main-container index-page">
            ...
            <footer>
                <div class="container-fluid index-footer">
                    <div class="row">
                        <div class="col-3">
                            <img class="footer-img" src="css/images/logo-footer.png" alt="Image">
                        </div>
                        <div class="col-9">
                            <div class="row">
                                <div class="col-2">
                                ...
                                <div class="col-10">
                                    <p>25 Centro St., Lawang Bato, Valenzuela, 1440 Metro Manila, Philippines</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
