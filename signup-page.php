...
<html lang="en">
    <head>
        ...
        <title>Nicollete's Pizza | Sign Up</title>
    </head>
    <body>
        <div class="main-container signin-page">
            <div class="navbar-menu">
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="signin-page.php">Sign In</a>
                    </li>
                </ul>
            </div>
            <div id="container" class="container-fluid">
                <form id="signupForm" class="sign-up">
                    <div class="row">
                        <div class="col">
                            <div class="text-desc">
                                <h3>Create Your Account</h3>
                                <p>Already have an account? <span><a href="signin-page.php">Sign in here.</a></span></p>
                            </div>
                        </div>
                    </div>
                    <div class="input-fields">
                        ...
                        <div class="row">
                            <div class="col">
                                <button type="submit" role="button" class="btn btn-warning signup-btn">Sign Up</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status == 'error') {
                                ...
                                setTimeout(function(){
                                    window.location.href = "/pizza_store/signin-page.php";
                                }, 2000);
                            }
                        }
                    });
